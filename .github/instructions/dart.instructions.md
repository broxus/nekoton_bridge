---
description: 'Instructions for writing Dart code following the official recommendations.'
applyTo: '**/*.dart'
---

# Dart
Best practices recommended by the Dart team. These instructions were taken from [Effective Dart](https://dart.dev/effective-dart) and [Architecture Recommendations](https://docs.flutter.dev/app-architecture/recommendations).
