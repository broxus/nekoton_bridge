...
extension SymbolPatterns on Symbol {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Symbol value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String name, String fullName, int decimals,
    ...
    switch (_that) {
      case _Symbol() when $default != null:
        return $default(_that.name, _that.fullName, _that.decimals,
            _that.rootTokenContract);
      case _:
        return orElse();
    }
  }
