...
extension TokenSwapBackPatterns on TokenSwapBack {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TokenSwapBack value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@amountJsonConverter BigInt tokens,
            Address callbackAddress, String callbackPayload)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TokenSwapBack() when $default != null:
        return $default(
            _that.tokens, _that.callbackAddress, _that.callbackPayload);
      case _:
        return orElse();
    }
  }
