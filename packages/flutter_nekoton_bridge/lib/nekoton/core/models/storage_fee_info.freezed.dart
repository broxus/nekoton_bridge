...
extension StorageFeeInfoPatterns on StorageFeeInfo {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_StorageFeeInfo value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String storageFee, String? storageFeeDebt,
            String accountStatus, String freezeDueLimit, String deleteDueLimit)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StorageFeeInfo() when $default != null:
        return $default(_that.storageFee, _that.storageFeeDebt,
            _that.accountStatus, _that.freezeDueLimit, _that.deleteDueLimit);
      case _:
        return orElse();
    }
  }
