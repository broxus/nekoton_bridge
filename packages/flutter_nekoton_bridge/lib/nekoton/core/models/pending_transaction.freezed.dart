...
mixin _$PendingTransaction {
 ...
 String get messageHash; Address? get src;@dateSecondsSinceEpochJsonConverter DateTime get expireAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PendingTransaction&&(identical(other.messageHash, messageHash) || other.messageHash == messageHash)&&(identical(other.src, src) || other.src == src)&&(identical(other.expireAt, expireAt) || other.expireAt == expireAt));
}
...
@useResult
$Res call({
 String messageHash, Address? src,@dateSecondsSinceEpochJsonConverter DateTime expireAt
});
...
/// Create a copy of PendingTransaction
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? messageHash = null,Object? src = freezed,Object? expireAt = null,}) {
...
as Address?,expireAt: null == expireAt ? _self.expireAt : expireAt // ignore: cast_nullable_to_non_nullable
as DateTime,
  ));
}
/// Create a copy of PendingTransaction
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String messageHash,  Address? src, @dateSecondsSinceEpochJsonConverter  DateTime expireAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PendingTransaction() when $default != null:
return $default(_that.messageHash,_that.src,_that.expireAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String messageHash,  Address? src, @dateSecondsSinceEpochJsonConverter  DateTime expireAt)  $default,) {final _that = this;
switch (_that) {
case _PendingTransaction():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String messageHash,  Address? src, @dateSecondsSinceEpochJsonConverter  DateTime expireAt)?  $default,) {final _that = this;
switch (_that) {
case _PendingTransaction() when $default != null:
return $default(_that.messageHash,_that.src,_that.expireAt);case _:
  return null;
...
class _PendingTransaction extends PendingTransaction {
  const _PendingTransaction({required this.messageHash, this.src, @dateSecondsSinceEpochJsonConverter required this.expireAt}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PendingTransaction&&(identical(other.messageHash, messageHash) || other.messageHash == messageHash)&&(identical(other.src, src) || other.src == src)&&(identical(other.expireAt, expireAt) || other.expireAt == expireAt));
}
...
@override $AddressCopyWith<$Res>? get src;
...
/// Create a copy of PendingTransaction
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? messageHash = null,Object? src = freezed,Object? expireAt = null,}) {
