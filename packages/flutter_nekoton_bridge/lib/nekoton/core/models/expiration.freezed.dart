...
extension ExpirationPatterns on Expiration {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(ExpirationNever value)? never,
    TResult Function(ExpirationTimeout value)? timeout,
    TResult Function(ExpirationTimestamp value)? timestamp,
    ...
    switch (_that) {
      case ExpirationNever() when never != null:
        return never(_that);
      case ExpirationTimeout() when timeout != null:
        return timeout(_that);
      case ExpirationTimestamp() when timestamp != null:
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(ExpirationNever value) never,
    required TResult Function(ExpirationTimeout value) timeout,
    required TResult Function(ExpirationTimestamp value) timestamp,
  }) {
    final _that = this;
    switch (_that) {
