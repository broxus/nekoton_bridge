...
extension InternalMessagePatterns on InternalMessage {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_InternalMessage value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(Address? source, Address destination,
            @amountJsonConverter BigInt amount, bool bounce, String body)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _InternalMessage() when $default != null:
        return $default(_that.source, _that.destination, _that.amount,
            _that.bounce, _that.body);
      case _:
        return orElse();
    }
  }
