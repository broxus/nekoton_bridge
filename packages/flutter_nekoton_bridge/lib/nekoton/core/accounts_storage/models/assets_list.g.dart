...
_AssetsList _$AssetsListFromJson(Map<String, dynamic> json) => _AssetsList(
  ...
  tonWallet: TonWalletAsset.fromJson(json['tonWallet'] as Map<String, dynamic>),
  additionalAssets: (json['additionalAssets'] as Map<String, dynamic>).map(
    (k, e) => MapEntry(k, AdditionalAssets.fromJson(e as Map<String, dynamic>)),
  ),
);
...
Map<String, dynamic> _$AssetsListToJson(_AssetsList instance) =>
    <String, dynamic>{
      ...
      'additionalAssets': instance.additionalAssets.map(
