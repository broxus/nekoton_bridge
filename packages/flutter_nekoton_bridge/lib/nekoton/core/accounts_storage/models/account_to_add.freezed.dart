...
extension AccountToAddPatterns on AccountToAdd {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AccountToAdd value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String name, PublicKey publicKey, WalletType contract,
            int workchain, Address? explicitAddress)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AccountToAdd() when $default != null:
        return $default(_that.name, _that.publicKey, _that.contract,
            _that.workchain, _that.explicitAddress);
      case _:
        return orElse();
    }
  }
