...
extension JettonMetaDataPatterns on JettonMetaData {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_JettonMetaData value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? name, String? uri, String? symbol,
            String? description, String? image, int? decimals)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _JettonMetaData() when $default != null:
        return $default(_that.name, _that.uri, _that.symbol, _that.description,
            _that.image, _that.decimals);
      case _:
        return orElse();
    }
  }
