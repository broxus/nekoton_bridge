...
extension ExistingWalletInfoPatterns on ExistingWalletInfo {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ExistingWalletInfo value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(Address address, PublicKey publicKey,
            WalletType walletType, ContractState contractState)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ExistingWalletInfo() when $default != null:
        return $default(_that.address, _that.publicKey, _that.walletType,
            _that.contractState);
      case _:
        return orElse();
    }
