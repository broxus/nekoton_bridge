...
import 'package:flutter_nekoton_bridge/nekoton/core/ton_wallet/models/multisig_confirm_update_transaction.dart';
import 'package:flutter_nekoton_bridge/nekoton/core/ton_wallet/models/multisig_execute_update_transaction.dart';
...
import 'package:flutter_nekoton_bridge/nekoton/core/ton_wallet/models/multisig_submit_update_transaction.dart';
...
sealed class MultisigTransaction with _$MultisigTransaction {
  ...
  const factory MultisigTransaction.submitUpdate(
    final MultisigSubmitUpdateTransaction data,
  ) = MultisigTransactionSubmitUpdate;

  const factory MultisigTransaction.confirmUpdate(
    final MultisigConfirmUpdateTransaction data,
  ) = MultisigTransactionConfirmUpdate;

  const factory MultisigTransaction.executeUpdate(
    final MultisigExecuteUpdateTransaction data,
