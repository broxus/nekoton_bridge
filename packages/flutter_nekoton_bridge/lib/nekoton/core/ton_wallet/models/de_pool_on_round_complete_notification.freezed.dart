...
extension DePoolOnRoundCompleteNotificationPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DePoolOnRoundCompleteNotification value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _DePoolOnRoundCompleteNotification() when $default != null:
        return $default(_that.roundId, _that.reward, _that.ordinaryStake,
            _that.vestingStake, _that.lockStake, _that.reinvest, _that.reason);
      case _:
        return orElse();
    }
  }
