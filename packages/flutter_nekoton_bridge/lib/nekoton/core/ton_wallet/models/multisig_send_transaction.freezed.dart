...
$MultisigSendTransactionCopyWith<MultisigSendTransaction> get copyWith => _$MultisigSendTransactionCopyWithImpl<MultisigSendTransaction>(this as MultisigSendTransaction, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MultisigSendTransaction&&(identical(other.dest, dest) || other.dest == dest)&&(identical(other.value, value) || other.value == value)&&(identical(other.bounce, bounce) || other.bounce == bounce)&&(identical(other.flags, flags) || other.flags == flags)&&(identical(other.payload, payload) || other.payload == payload));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,dest,value,bounce,flags,payload);
...
/// Create a copy of MultisigSendTransaction
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? dest = null,Object? value = null,Object? bounce = null,Object? flags = null,Object? payload = null,}) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MultisigSendTransaction value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MultisigSendTransaction value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MultisigSendTransaction value)?  $default,){
final _that = this;
switch (_that) {
case _MultisigSendTransaction() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$MultisigSendTransactionCopyWith<_MultisigSendTransaction> get copyWith => __$MultisigSendTransactionCopyWithImpl<_MultisigSendTransaction>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$MultisigSendTransactionToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MultisigSendTransaction&&(identical(other.dest, dest) || other.dest == dest)&&(identical(other.value, value) || other.value == value)&&(identical(other.bounce, bounce) || other.bounce == bounce)&&(identical(other.flags, flags) || other.flags == flags)&&(identical(other.payload, payload) || other.payload == payload));
}
...
/// @nodoc
abstract mixin class _$MultisigSendTransactionCopyWith<$Res> implements $MultisigSendTransactionCopyWith<$Res> {
...
@override $AddressCopyWith<$Res> get dest;
...
/// Create a copy of MultisigSendTransaction
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? dest = null,Object? value = null,Object? bounce = null,Object? flags = null,Object? payload = null,}) {
