...
_$WalletInteractionMethodWalletV3TransferFromJson(Map<String, dynamic> json) =>
    WalletInteractionMethodWalletV3Transfer($type: json['type'] as String?);
...
_$WalletInteractionMethodTonWalletTransferFromJson(Map<String, dynamic> json) =>
    WalletInteractionMethodTonWalletTransfer($type: json['type'] as String?);
