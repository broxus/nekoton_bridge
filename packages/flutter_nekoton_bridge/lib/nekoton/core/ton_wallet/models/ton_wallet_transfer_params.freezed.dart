...
extension TonWalletTransferParamsPatterns on TonWalletTransferParams {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TonWalletTransferParams value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(Address destination, @amountJsonConverter BigInt amount,
            bool bounce, String? body, String? stateInit)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TonWalletTransferParams() when $default != null:
        return $default(_that.destination, _that.amount, _that.bounce,
            _that.body, _that.stateInit);
      case _:
        return orElse();
    }
  }
