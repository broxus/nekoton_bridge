...
$TokenWalletDeployedNotificationCopyWith<TokenWalletDeployedNotification> get copyWith => _$TokenWalletDeployedNotificationCopyWithImpl<TokenWalletDeployedNotification>(this as TokenWalletDeployedNotification, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TokenWalletDeployedNotification&&(identical(other.rootTokenContract, rootTokenContract) || other.rootTokenContract == rootTokenContract));
}
...
abstract mixin class $TokenWalletDeployedNotificationCopyWith<$Res>  {
  factory $TokenWalletDeployedNotificationCopyWith(TokenWalletDeployedNotification value, $Res Function(TokenWalletDeployedNotification) _then) = _$TokenWalletDeployedNotificationCopyWithImpl;
@useResult
$Res call({
...
extension TokenWalletDeployedNotificationPatterns on TokenWalletDeployedNotification {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TokenWalletDeployedNotification value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TokenWalletDeployedNotification value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TokenWalletDeployedNotification value)?  $default,){
final _that = this;
switch (_that) {
case _TokenWalletDeployedNotification() when $default != null:
return $default(_that);case _:
...
class _TokenWalletDeployedNotification implements TokenWalletDeployedNotification {
  const _TokenWalletDeployedNotification({required this.rootTokenContract});
  factory _TokenWalletDeployedNotification.fromJson(Map<String, dynamic> json) => _$TokenWalletDeployedNotificationFromJson(json);
...
@pragma('vm:prefer-inline')
_$TokenWalletDeployedNotificationCopyWith<_TokenWalletDeployedNotification> get copyWith => __$TokenWalletDeployedNotificationCopyWithImpl<_TokenWalletDeployedNotification>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$TokenWalletDeployedNotificationToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TokenWalletDeployedNotification&&(identical(other.rootTokenContract, rootTokenContract) || other.rootTokenContract == rootTokenContract));
}
...
/// @nodoc
abstract mixin class _$TokenWalletDeployedNotificationCopyWith<$Res> implements $TokenWalletDeployedNotificationCopyWith<$Res> {
  factory _$TokenWalletDeployedNotificationCopyWith(_TokenWalletDeployedNotification value, $Res Function(_TokenWalletDeployedNotification) _then) = __$TokenWalletDeployedNotificationCopyWithImpl;
@override @useResult
$Res call({
 Address rootTokenContract
});
