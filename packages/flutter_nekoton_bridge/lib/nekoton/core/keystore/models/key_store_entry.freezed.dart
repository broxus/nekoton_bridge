...
extension KeyStoreEntryPatterns on KeyStoreEntry {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_KeyStoreEntry value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String signerName, String name, PublicKey publicKey,
            PublicKey masterKey, int accountId)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _KeyStoreEntry() when $default != null:
        return $default(_that.signerName, _that.name, _that.publicKey,
            _that.masterKey, _that.accountId);
      case _:
        return orElse();
    }
  }
