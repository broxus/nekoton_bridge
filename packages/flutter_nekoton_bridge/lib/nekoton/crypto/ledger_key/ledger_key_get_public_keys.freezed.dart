...
$LedgerKeyGetPublicKeysCopyWith<LedgerKeyGetPublicKeys> get copyWith => _$LedgerKeyGetPublicKeysCopyWithImpl<LedgerKeyGetPublicKeys>(this as LedgerKeyGetPublicKeys, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LedgerKeyGetPublicKeys&&(identical(other.offset, offset) || other.offset == offset)&&(identical(other.limit, limit) || other.limit == limit));
}
...
abstract mixin class $LedgerKeyGetPublicKeysCopyWith<$Res>  {
  factory $LedgerKeyGetPublicKeysCopyWith(LedgerKeyGetPublicKeys value, $Res Function(LedgerKeyGetPublicKeys) _then) = _$LedgerKeyGetPublicKeysCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LedgerKeyGetPublicKeys value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LedgerKeyGetPublicKeys value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LedgerKeyGetPublicKeys value)?  $default,){
final _that = this;
switch (_that) {
case _LedgerKeyGetPublicKeys() when $default != null:
return $default(_that);case _:
...
class _LedgerKeyGetPublicKeys implements LedgerKeyGetPublicKeys {
  ...
  factory _LedgerKeyGetPublicKeys.fromJson(Map<String, dynamic> json) => _$LedgerKeyGetPublicKeysFromJson(json);
...
@pragma('vm:prefer-inline')
_$LedgerKeyGetPublicKeysCopyWith<_LedgerKeyGetPublicKeys> get copyWith => __$LedgerKeyGetPublicKeysCopyWithImpl<_LedgerKeyGetPublicKeys>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LedgerKeyGetPublicKeysToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LedgerKeyGetPublicKeys&&(identical(other.offset, offset) || other.offset == offset)&&(identical(other.limit, limit) || other.limit == limit));
}
...
/// @nodoc
abstract mixin class _$LedgerKeyGetPublicKeysCopyWith<$Res> implements $LedgerKeyGetPublicKeysCopyWith<$Res> {
  factory _$LedgerKeyGetPublicKeysCopyWith(_LedgerKeyGetPublicKeys value, $Res Function(_LedgerKeyGetPublicKeys) _then) = __$LedgerKeyGetPublicKeysCopyWithImpl;
@override @useResult
$Res call({
 int offset, int limit
});
