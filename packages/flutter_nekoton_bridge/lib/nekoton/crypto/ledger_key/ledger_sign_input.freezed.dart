...
extension LedgerSignInputPatterns on LedgerSignInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LedgerSignInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(WalletType wallet, PublicKey publicKey,
            LedgerSignatureContext? context)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _LedgerSignInput() when $default != null:
        return $default(_that.wallet, _that.publicKey, _that.context);
      case _:
        return orElse();
    }
  }
