...
extension DerivedKeyCreateInputDerivePatterns on DerivedKeyCreateInputDerive {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DerivedKeyCreateInputDerive value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? keyName, PublicKey masterKey, int accountId,
            Password password)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _DerivedKeyCreateInputDerive() when $default != null:
        return $default(
            _that.keyName, _that.masterKey, _that.accountId, _that.password);
      case _:
        return orElse();
    }
  }
