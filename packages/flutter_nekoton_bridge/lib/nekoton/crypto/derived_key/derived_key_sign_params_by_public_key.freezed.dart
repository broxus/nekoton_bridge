...
extension DerivedKeyPasswordByPublicKeyPatterns
    on DerivedKeyPasswordByPublicKey {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DerivedKeyPasswordByPublicKey value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _DerivedKeyPasswordByPublicKey() when $default != null:
        return $default(_that.masterKey, _that.publicKey, _that.password);
      case _:
        return orElse();
    }
  }
