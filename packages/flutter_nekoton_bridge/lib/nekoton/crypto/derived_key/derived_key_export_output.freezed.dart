...
$DerivedKeyExportOutputCopyWith<DerivedKeyExportOutput> get copyWith => _$DerivedKeyExportOutputCopyWithImpl<DerivedKeyExportOutput>(this as DerivedKeyExportOutput, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DerivedKeyExportOutput&&(identical(other.phrase, phrase) || other.phrase == phrase));
}
...
abstract mixin class $DerivedKeyExportOutputCopyWith<$Res>  {
  factory $DerivedKeyExportOutputCopyWith(DerivedKeyExportOutput value, $Res Function(DerivedKeyExportOutput) _then) = _$DerivedKeyExportOutputCopyWithImpl;
@useResult
$Res call({
 String phrase
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _DerivedKeyExportOutput value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _DerivedKeyExportOutput value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _DerivedKeyExportOutput value)?  $default,){
final _that = this;
switch (_that) {
case _DerivedKeyExportOutput() when $default != null:
return $default(_that);case _:
...
class _DerivedKeyExportOutput implements DerivedKeyExportOutput {
  ...
  factory _DerivedKeyExportOutput.fromJson(Map<String, dynamic> json) => _$DerivedKeyExportOutputFromJson(json);
...
@pragma('vm:prefer-inline')
_$DerivedKeyExportOutputCopyWith<_DerivedKeyExportOutput> get copyWith => __$DerivedKeyExportOutputCopyWithImpl<_DerivedKeyExportOutput>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$DerivedKeyExportOutputToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DerivedKeyExportOutput&&(identical(other.phrase, phrase) || other.phrase == phrase));
}
...
/// @nodoc
abstract mixin class _$DerivedKeyExportOutputCopyWith<$Res> implements $DerivedKeyExportOutputCopyWith<$Res> {
  factory _$DerivedKeyExportOutputCopyWith(_DerivedKeyExportOutput value, $Res Function(_DerivedKeyExportOutput) _then) = __$DerivedKeyExportOutputCopyWithImpl;
@override @useResult
$Res call({
 String phrase
});
