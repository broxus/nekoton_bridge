...
extension DerivedKeyUpdateParamsRenameKeyPatterns
    on DerivedKeyUpdateParamsRenameKey {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DerivedKeyUpdateParamsRenameKey value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(PublicKey masterKey, PublicKey publicKey, String name)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _DerivedKeyUpdateParamsRenameKey() when $default != null:
        return $default(_that.masterKey, _that.publicKey, _that.name);
      case _:
        return orElse();
    }
  }
