...
mixin _$Keypair {
 ...
 PublicKey get public; PublicKey get secret;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Keypair&&(identical(other.public, public) || other.public == public)&&(identical(other.secret, secret) || other.secret == secret));
}
...
$PublicKeyCopyWith<$Res> get public;$PublicKeyCopyWith<$Res> get secret;
...
/// Create a copy of Keypair
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? public = null,Object? secret = null,}) {
  return _then(_self.copyWith(
public: null == public ? _self.public : public // ignore: cast_nullable_to_non_nullable
as PublicKey,secret: null == secret ? _self.secret : secret // ignore: cast_nullable_to_non_nullable
as PublicKey,
  ));
}
/// Create a copy of Keypair
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PublicKey public,  PublicKey secret)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Keypair() when $default != null:
return $default(_that.public,_that.secret);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PublicKey public,  PublicKey secret)  $default,) {final _that = this;
switch (_that) {
case _Keypair():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PublicKey public,  PublicKey secret)?  $default,) {final _that = this;
switch (_that) {
case _Keypair() when $default != null:
return $default(_that.public,_that.secret);case _:
  return null;
...
class _Keypair implements Keypair {
  ...
  factory _Keypair.fromJson(Map<String, dynamic> json) => _$KeypairFromJson(json);

@override final  PublicKey public;
@override final  PublicKey secret;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Keypair&&(identical(other.public, public) || other.public == public)&&(identical(other.secret, secret) || other.secret == secret));
}
...
@override $PublicKeyCopyWith<$Res> get public;@override $PublicKeyCopyWith<$Res> get secret;
...
/// Create a copy of Keypair
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? public = null,Object? secret = null,}) {
