...
mixin _$EncryptedData {
 ...
 EncryptionAlgorithm get algorithm; PublicKey get sourcePublicKey; PublicKey get recipientPublicKey; String get data; String get nonce;
...
@useResult
$Res call({
 EncryptionAlgorithm algorithm, PublicKey sourcePublicKey, PublicKey recipientPublicKey, String data, String nonce
});


$PublicKeyCopyWith<$Res> get sourcePublicKey;$PublicKeyCopyWith<$Res> get recipientPublicKey;
...
/// Create a copy of EncryptedData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? algorithm = null,Object? sourcePublicKey = null,Object? recipientPublicKey = null,Object? data = null,Object? nonce = null,}) {
  return _then(_self.copyWith(
algorithm: null == algorithm ? _self.algorithm : algorithm // ignore: cast_nullable_to_non_nullable
as EncryptionAlgorithm,sourcePublicKey: null == sourcePublicKey ? _self.sourcePublicKey : sourcePublicKey // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( EncryptionAlgorithm algorithm,  PublicKey sourcePublicKey,  PublicKey recipientPublicKey,  String data,  String nonce)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EncryptedData() when $default != null:
return $default(_that.algorithm,_that.sourcePublicKey,_that.recipientPublicKey,_that.data,_that.nonce);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( EncryptionAlgorithm algorithm,  PublicKey sourcePublicKey,  PublicKey recipientPublicKey,  String data,  String nonce)  $default,) {final _that = this;
switch (_that) {
case _EncryptedData():
return $default(_that.algorithm,_that.sourcePublicKey,_that.recipientPublicKey,_that.data,_that.nonce);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( EncryptionAlgorithm algorithm,  PublicKey sourcePublicKey,  PublicKey recipientPublicKey,  String data,  String nonce)?  $default,) {final _that = this;
switch (_that) {
case _EncryptedData() when $default != null:
return $default(_that.algorithm,_that.sourcePublicKey,_that.recipientPublicKey,_that.data,_that.nonce);case _:
  return null;
...
class _EncryptedData implements EncryptedData {
  const _EncryptedData({required this.algorithm, required this.sourcePublicKey, required this.recipientPublicKey, required this.data, required this.nonce});
  factory _EncryptedData.fromJson(Map<String, dynamic> json) => _$EncryptedDataFromJson(json);

@override final  EncryptionAlgorithm algorithm;
@override final  PublicKey sourcePublicKey;
@override final  PublicKey recipientPublicKey;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EncryptedData&&(identical(other.algorithm, algorithm) || other.algorithm == algorithm)&&(identical(other.sourcePublicKey, sourcePublicKey) || other.sourcePublicKey == sourcePublicKey)&&(identical(other.recipientPublicKey, recipientPublicKey) || other.recipientPublicKey == recipientPublicKey)&&(identical(other.data, data) || other.data == data)&&(identical(other.nonce, nonce) || other.nonce == nonce));
}
...
@override $PublicKeyCopyWith<$Res> get sourcePublicKey;@override $PublicKeyCopyWith<$Res> get recipientPublicKey;
...
/// Create a copy of EncryptedData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? algorithm = null,Object? sourcePublicKey = null,Object? recipientPublicKey = null,Object? data = null,Object? nonce = null,}) {
