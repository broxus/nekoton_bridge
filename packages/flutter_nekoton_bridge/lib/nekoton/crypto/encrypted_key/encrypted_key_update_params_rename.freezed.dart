...
$EncryptedKeyUpdateParamsRenameCopyWith<EncryptedKeyUpdateParamsRename> get copyWith => _$EncryptedKeyUpdateParamsRenameCopyWithImpl<EncryptedKeyUpdateParamsRename>(this as EncryptedKeyUpdateParamsRename, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EncryptedKeyUpdateParamsRename&&(identical(other.publicKey, publicKey) || other.publicKey == publicKey)&&(identical(other.name, name) || other.name == name));
}
...
abstract mixin class $EncryptedKeyUpdateParamsRenameCopyWith<$Res>  {
  factory $EncryptedKeyUpdateParamsRenameCopyWith(EncryptedKeyUpdateParamsRename value, $Res Function(EncryptedKeyUpdateParamsRename) _then) = _$EncryptedKeyUpdateParamsRenameCopyWithImpl;
@useResult
$Res call({
...
extension EncryptedKeyUpdateParamsRenamePatterns on EncryptedKeyUpdateParamsRename {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EncryptedKeyUpdateParamsRename value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EncryptedKeyUpdateParamsRename value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EncryptedKeyUpdateParamsRename value)?  $default,){
final _that = this;
switch (_that) {
case _EncryptedKeyUpdateParamsRename() when $default != null:
return $default(_that);case _:
...
class _EncryptedKeyUpdateParamsRename implements EncryptedKeyUpdateParamsRename {
  const _EncryptedKeyUpdateParamsRename({required this.publicKey, required this.name});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EncryptedKeyUpdateParamsRename&&(identical(other.publicKey, publicKey) || other.publicKey == publicKey)&&(identical(other.name, name) || other.name == name));
}
...
/// @nodoc
abstract mixin class _$EncryptedKeyUpdateParamsRenameCopyWith<$Res> implements $EncryptedKeyUpdateParamsRenameCopyWith<$Res> {
