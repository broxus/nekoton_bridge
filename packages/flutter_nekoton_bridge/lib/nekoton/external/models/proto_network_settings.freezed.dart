...
$ProtoNetworkSettingsCopyWith<ProtoNetworkSettings> get copyWith => _$ProtoNetworkSettingsCopyWithImpl<ProtoNetworkSettings>(this as ProtoNetworkSettings, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProtoNetworkSettings&&(identical(other.endpoint, endpoint) || other.endpoint == endpoint));
}
...
abstract mixin class $ProtoNetworkSettingsCopyWith<$Res>  {
  factory $ProtoNetworkSettingsCopyWith(ProtoNetworkSettings value, $Res Function(ProtoNetworkSettings) _then) = _$ProtoNetworkSettingsCopyWithImpl;
@useResult
$Res call({
 String endpoint
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ProtoNetworkSettings value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ProtoNetworkSettings value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ProtoNetworkSettings value)?  $default,){
final _that = this;
switch (_that) {
case _ProtoNetworkSettings() when $default != null:
return $default(_that);case _:
...
class _ProtoNetworkSettings implements ProtoNetworkSettings {
  ...
  factory _ProtoNetworkSettings.fromJson(Map<String, dynamic> json) => _$ProtoNetworkSettingsFromJson(json);
...
@pragma('vm:prefer-inline')
_$ProtoNetworkSettingsCopyWith<_ProtoNetworkSettings> get copyWith => __$ProtoNetworkSettingsCopyWithImpl<_ProtoNetworkSettings>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ProtoNetworkSettingsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProtoNetworkSettings&&(identical(other.endpoint, endpoint) || other.endpoint == endpoint));
}
...
/// @nodoc
abstract mixin class _$ProtoNetworkSettingsCopyWith<$Res> implements $ProtoNetworkSettingsCopyWith<$Res> {
  factory _$ProtoNetworkSettingsCopyWith(_ProtoNetworkSettings value, $Res Function(_ProtoNetworkSettings) _then) = __$ProtoNetworkSettingsCopyWithImpl;
@override @useResult
$Res call({
 String endpoint
});
