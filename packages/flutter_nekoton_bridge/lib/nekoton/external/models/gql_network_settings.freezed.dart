...
extension GqlNetworkSettingsPatterns on GqlNetworkSettings {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GqlNetworkSettings value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String> endpoints, int latencyDetectionInterval,
    ...
    switch (_that) {
      case _GqlNetworkSettings() when $default != null:
        return $default(_that.endpoints, _that.latencyDetectionInterval,
            _that.maxLatency, _that.endpointSelectionRetryCount, _that.local);
      case _:
        return orElse();
    }
  }
