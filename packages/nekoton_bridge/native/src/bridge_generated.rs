...
mod web {
    ...
    #[wasm_bindgen]
    pub fn wire_nt_generate_key(account_type: JsValue) -> support::WireSyncReturn {
        wire_nt_generate_key_impl(account_type)
    }

    #[wasm_bindgen]
    pub fn wire_nt_get_hints(input: String) -> support::WireSyncReturn {
        wire_nt_get_hints_impl(input)
    }

    #[wasm_bindgen]
    pub fn wire_nt_derive_from_phrase(
        phrase: String,
        mnemonic_type: JsValue,
    ) -> support::WireSyncReturn {
...
mod io {
    ...
    pub extern "C" fn wire_nt_generate_key(
        account_type: *mut wire_MnemonicType,
    ) -> support::WireSyncReturn {
        wire_nt_generate_key_impl(account_type)
    }
