...
impl GqlTransportImpl {
    ...
    pub async fn get_contract_state(&self, address: String) -> anyhow::Result<String> {
    ...
    pub async fn get_full_contract_state(&self, address: String) -> anyhow::Result<Option<String>> {
    ...
    pub async fn get_transaction(&self, hash: String) -> anyhow::Result<Option<String>> {
    ...
    pub async fn get_dst_transaction(
        ...
        self.inner_transport.get_dst_transaction(message_hash).await
    }
    ...
    pub async fn get_blockchain_config(&self, force: bool) -> anyhow::Result<String> {
        self.inner_transport.get_blockchain_config(force).await
    }

    /// Get id of network or throw error
    pub async fn get_network_id(&self) -> anyhow::Result<i32> {
        self.inner_transport.get_network_id().await
    }

    /// Get latest block by address and return it or throw error
    pub async fn get_latest_block(&self, address: String) -> anyhow::Result<LatestBlock> {
    ...
    pub async fn get_block(&self, id: String) -> anyhow::Result<String> {
    ...
    pub async fn simulate_transaction_tree(
        &self,
    ...
    pub async fn get_fee_factors(&self, is_masterchain: bool) -> anyhow::Result<String> {
        self.inner_transport.get_fee_factors(is_masterchain).await
    }
}
