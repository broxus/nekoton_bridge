...
// These types are ignored because they are not used by any `pub` functions: `GenericContractSubscriptionHandlerImpl`, `GqlConnectionImpl`, `JettonWalletSubscriptionHandlerImpl`, `JrpcConnectionImpl`, `ProtoConnectionImpl`, `ProviderMessage`, `ProviderTransaction`, `TokenWalletSubscriptionHandlerImpl`, `TonWalletSubscriptionHandlerImpl`
...
Future<GeneratedKeyG> ntGenerateKey({required MnemonicType accountType}) =>
...
Future<List<String>> ntGetHints({required String input}) =>
