...
class NekotonBridgeWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_resend_mnemonicPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Pointer<wire_MnemonicType>)>>('wire_resend_mnemonic');
  late final _wire_resend_mnemonic = _wire_resend_mnemonicPtr.asFunction<void Function(int, ffi.Pointer<wire_MnemonicType>)>();
  ...
  late final _wire_nt_generate_keyPtr = _lookup<ffi.NativeFunction<WireSyncReturn Function(ffi.Pointer<wire_MnemonicType>)>>('wire_nt_generate_key');
  late final _wire_nt_generate_key = _wire_nt_generate_keyPtr.asFunction<WireSyncReturn Function(ffi.Pointer<wire_MnemonicType>)>();
  ...
  late final _wire_nt_derive_from_phrasePtr = _lookup<ffi.NativeFunction<WireSyncReturn Function(ffi.Pointer<wire_uint_8_list>, ffi.Pointer<wire_MnemonicType>)>>('wire_nt_derive_from_phrase');
  late final _wire_nt_derive_from_phrase = _wire_nt_derive_from_phrasePtr.asFunction<WireSyncReturn Function(ffi.Pointer<wire_uint_8_list>, ffi.Pointer<wire_MnemonicType>)>();
  ...
  late final _wire_simple_call_func0Ptr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>('wire_simple_call_func0');
  late final _wire_simple_call_func0 = _wire_simple_call_func0Ptr.asFunction<void Function(int)>();
