...
@protected
                    wire_ArcJettonWalletBoxTrait api2wire_ArcJettonWalletBoxTrait(ArcJettonWalletBoxTrait raw) {
...
@protected
                    wire_ArcProtoConnectionBoxTrait api2wire_ArcProtoConnectionBoxTrait(ArcProtoConnectionBoxTrait raw) {
...
@protected
                    ffi.Pointer<wire_JettonWalletDartWrapper> api2wire_box_autoadd_jetton_wallet_dart_wrapper(JettonWalletDartWrapper raw) {
...
@protected
                    ffi.Pointer<wire_ProtoConnectionDartWrapper> api2wire_box_autoadd_proto_connection_dart_wrapper(ProtoConnectionDartWrapper raw) {
...
@protected
                    ffi.Pointer<wire_ProtoTransportImpl> api2wire_box_autoadd_proto_transport_impl(ProtoTransportImpl raw) {
...
late final OpaqueTypeFinalizer _ArcJettonWalletBoxTraitFinalizer = OpaqueTypeFinalizer(inner._drop_opaque_ArcJettonWalletBoxTraitPtr);
            OpaqueTypeFinalizer get ArcJettonWalletBoxTraitFinalizer => _ArcJettonWalletBoxTraitFinalizer;
...
late final OpaqueTypeFinalizer _ArcProtoConnectionBoxTraitFinalizer = OpaqueTypeFinalizer(inner._drop_opaque_ArcProtoConnectionBoxTraitPtr);
            OpaqueTypeFinalizer get ArcProtoConnectionBoxTraitFinalizer => _ArcProtoConnectionBoxTraitFinalizer;
...
void _api_fill_to_wire_ArcJettonWalletBoxTrait(ArcJettonWalletBoxTrait apiObj, wire_ArcJettonWalletBoxTrait wireObj) {
                wireObj.ptr = apiObj.shareOrMove();
            }
...
void _api_fill_to_wire_ArcProtoConnectionBoxTrait(ArcProtoConnectionBoxTrait apiObj, wire_ArcProtoConnectionBoxTrait wireObj) {
                wireObj.ptr = apiObj.shareOrMove();
            }
...
void _api_fill_to_wire_box_autoadd_jetton_wallet_dart_wrapper(JettonWalletDartWrapper apiObj, ffi.Pointer<wire_JettonWalletDartWrapper> wireObj) {
...
void _api_fill_to_wire_box_autoadd_proto_connection_dart_wrapper(ProtoConnectionDartWrapper apiObj, ffi.Pointer<wire_ProtoConnectionDartWrapper> wireObj) {
                _api_fill_to_wire_proto_connection_dart_wrapper(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_proto_transport_impl(ProtoTransportImpl apiObj, ffi.Pointer<wire_ProtoTransportImpl> wireObj) {
...
if (apiObj is DynamicValue_None) { wireObj.tag = 11; return; }
            }
...
void _api_fill_to_wire_jetton_wallet_dart_wrapper(JettonWalletDartWrapper apiObj, wire_JettonWalletDartWrapper wireObj) {
...
void _api_fill_to_wire_key_signer(KeySigner apiObj, wire_KeySigner wireObj) {
                if (apiObj is KeySigner_Encrypted) { wireObj.tag = 0; return; }
if (apiObj is KeySigner_Derived) { wireObj.tag = 1; return; }
if (apiObj is KeySigner_Ledger) { wireObj.tag = 2; return; }
...
void _api_fill_to_wire_mnemonic_type(MnemonicType apiObj, wire_MnemonicType wireObj) {
                if (apiObj is MnemonicType_Legacy) { wireObj.tag = 0; return; }
...
void _api_fill_to_wire_proto_connection_dart_wrapper(ProtoConnectionDartWrapper apiObj, wire_ProtoConnectionDartWrapper wireObj) {
                wireObj.inner_connection = api2wire_ArcProtoConnectionBoxTrait(apiObj.innerConnection);
            }

void _api_fill_to_wire_proto_transport_impl(ProtoTransportImpl apiObj, wire_ProtoTransportImpl wireObj) {
                wireObj.inner_transport = api2wire_ArcTransportBoxTrait(apiObj.innerTransport);
            }
