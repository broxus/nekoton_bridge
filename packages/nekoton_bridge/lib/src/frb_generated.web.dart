...
abstract class NekotonBridgeApiImplPlatform
  ...
  @protected
  JSAny cst_encode_box_autoadd_transaction_execution_options(
      TransactionExecutionOptions raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return cst_encode_transaction_execution_options(raw);
  }
  ...
  JSAny cst_encode_mnemonic_type(MnemonicType raw) {
    ...
    if (raw is MnemonicType_Labs) {
      return [1, cst_encode_u_16(raw.field0)].jsify()!;
    }
  ...
  @protected
  JSAny cst_encode_transaction_execution_options(
      TransactionExecutionOptions raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return [
      cst_encode_bool(raw.disableSignatureCheck),
      cst_encode_opt_box_autoadd_u_64(raw.overrideBalance)
    ].jsify()!;
  }
...
class NekotonBridgeWire implements BaseWire {
  ...
  void wire__crate__api__merged__nt_derive_from_phrase(
          NativePortType port_, String phrase, JSAny mnemonic_type) =>
      wasmModule.wire__crate__api__merged__nt_derive_from_phrase(
          port_, phrase, mnemonic_type);
  ...
  void wire__crate__api__merged__nt_generate_key(
          NativePortType port_, JSAny account_type) =>
      wasmModule.wire__crate__api__merged__nt_generate_key(port_, account_type);
  ...
  void wire__crate__api__merged__nt_get_hints(
      ...
      wasmModule.wire__crate__api__merged__nt_get_hints(port_, input);
...
extension type NekotonBridgeWasmModule._(JSObject _) implements JSObject {
  ...
  external void wire__crate__api__merged__nt_derive_from_phrase(
      NativePortType port_, String phrase, JSAny mnemonic_type);
  ...
  external void wire__crate__api__merged__nt_generate_key(
      NativePortType port_, JSAny account_type);
  ...
  external void wire__crate__api__merged__nt_get_hints(
      NativePortType port_, String input);
