...
class LedgerApiImpl implements LedgerApi {
  final LedgerApiPlatform _platform;
  factory LedgerApiImpl(ExternalLibrary dylib) => LedgerApiImpl.raw(LedgerApiPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory LedgerApiImpl.wasm(FutureOr<WasmModule> module) => LedgerApiImpl(module as ExternalLibrary);
  LedgerApiImpl.raw(this._platform);
  void dispose() {
    _platform.dispose();
  }
// Section: wire2api
...
class LedgerApiPlatform extends FlutterRustBridgeBase<LedgerApiWire> {
  LedgerApiPlatform(ffi.DynamicLibrary dylib) : super(LedgerApiWire(dylib));
...
class LedgerApiWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  LedgerApiWire(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  LedgerApiWire.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup) : _lookup = lookup;
