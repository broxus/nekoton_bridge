...
abstract class DerivedKeyApi {}

class DerivedKeyApiImpl implements DerivedKeyApi {
  final DerivedKeyApiPlatform _platform;
  factory DerivedKeyApiImpl(ExternalLibrary dylib) => DerivedKeyApiImpl.raw(DerivedKeyApiPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory DerivedKeyApiImpl.wasm(FutureOr<WasmModule> module) => DerivedKeyApiImpl(module as ExternalLibrary);
  DerivedKeyApiImpl.raw(this._platform);
  void dispose() {
    _platform.dispose();
  }
// Section: wire2api
...
class DerivedKeyApiPlatform extends FlutterRustBridgeBase<DerivedKeyApiWire> {
  DerivedKeyApiPlatform(ffi.DynamicLibrary dylib) : super(DerivedKeyApiWire(dylib));
...
class DerivedKeyApiWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  DerivedKeyApiWire(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  DerivedKeyApiWire.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup) : _lookup = lookup;
