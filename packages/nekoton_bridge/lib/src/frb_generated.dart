...
abstract class NekotonBridgeApi extends BaseApi {
  ...
  Future<String> crateApiMergedNtDeriveFromPhrase(
  ...
  Future<GeneratedKeyG> crateApiMergedNtGenerateKey(
  ...
  Future<List<String>> crateApiMergedNtGetHints({required String input});
...
class NekotonBridgeApiImpl extends NekotonBridgeApiImplPlatform
  ...
  Future<GeneratedKeyG> crateApiMergedNtGenerateKey(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire__crate__api__merged__nt_generate_key(port_, arg0);
      },
      codec: DcoCodec(
  ...
  Future<List<String>> crateApiMergedNtGetHints({required String input}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire__crate__api__merged__nt_get_hints(port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_list_String,
        decodeErrorData: null,
  ...
  MnemonicType sse_decode_mnemonic_type(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 1:
        var var_field0 = sse_decode_u_16(deserializer);
        return MnemonicType_Labs(var_field0);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  void sse_encode_mnemonic_type(MnemonicType self, SseSerializer serializer) {
    ...
    switch (self) {
      case MnemonicType_Legacy():
        sse_encode_i_32(0, serializer);
      case MnemonicType_Labs(field0: final field0):
        sse_encode_i_32(1, serializer);
        sse_encode_u_16(field0, serializer);
    }
  }
