...
import 'bridge_generated.dart'; export 'bridge_generated.dart';
...
@protected
                    List<dynamic> api2wire_box_autoadd_jetton_wallet_dart_wrapper(JettonWalletDartWrapper raw) {
...
@protected
                    List<dynamic> api2wire_box_autoadd_proto_connection_dart_wrapper(ProtoConnectionDartWrapper raw) {
                        return api2wire_proto_connection_dart_wrapper(raw);
                    }
@protected
                    List<dynamic> api2wire_box_autoadd_proto_transport_impl(ProtoTransportImpl raw) {
...
@protected
                    List<dynamic> api2wire_dart_call_stub(DartCallStub raw) {
                        return [api2wire_String(raw.instanceHash),api2wire_String(raw.fnName),api2wire_list_dynamic_value(raw.args),api2wire_list_dynamic_named_value(raw.namedArgs)];
                    }
@protected
                    List<dynamic> api2wire_dynamic_named_value(DynamicNamedValue raw) {
                        return [api2wire_String(raw.name),api2wire_opt_box_autoadd_dynamic_value(raw.value)];
                    }
@protected
...
@protected
                    List<dynamic> api2wire_jetton_wallet_dart_wrapper(JettonWalletDartWrapper raw) {
...
@protected
                    List<dynamic> api2wire_proto_connection_dart_wrapper(ProtoConnectionDartWrapper raw) {
...
@protected
                    List<dynamic> api2wire_transaction_execution_options(TransactionExecutionOptions raw) {
                        return [api2wire_bool(raw.disableSignatureCheck),api2wire_opt_box_autoadd_u64(raw.overrideBalance)];
                    }
...
late final Finalizer<PlatformPointer> _ArcJettonWalletBoxTraitFinalizer = Finalizer<PlatformPointer>(inner.drop_opaque_ArcJettonWalletBoxTrait);
            Finalizer<PlatformPointer> get ArcJettonWalletBoxTraitFinalizer => _ArcJettonWalletBoxTraitFinalizer;
...
late final Finalizer<PlatformPointer> _ArcProtoConnectionBoxTraitFinalizer = Finalizer<PlatformPointer>(inner.drop_opaque_ArcProtoConnectionBoxTrait);
            Finalizer<PlatformPointer> get ArcProtoConnectionBoxTraitFinalizer => _ArcProtoConnectionBoxTraitFinalizer;
...
@JS('wasm_bindgen') external NekotonBridgeWasmModule get wasmModule;
@JS() @anonymous class NekotonBridgeWasmModule implements WasmModule {
            external Object /* Promise */ call([String? moduleName]);
            external NekotonBridgeWasmModule bind(dynamic thisArg, String moduleName);
external dynamic /* void */ wire_verify_signature(NativePortType port_,String public_key,String data,String signature,int? signature_id);
...
external dynamic /* void */ wire_pack_into_cell(NativePortType port_,String params,String tokens,String? version);

external dynamic /* void */ wire_unpack_from_cell(NativePortType port_,String params,String boc,bool allow_partial,String? version);
...
external dynamic /* String */ wire_pack_address(String address,bool is_url_safe,bool bounceable);
...
external dynamic /* void */ wire_execute_local(NativePortType port_,String config,String account,String message,int utime,bool disable_signature_check,String? overwrite_balance,int? global_id);

external dynamic /* void */ wire_unpack_init_data(NativePortType port_,String contract_abi,String data);

external dynamic /* void */ wire_unpack_contract_fields(NativePortType port_,String contract_abi,String boc,bool allow_partial);

external dynamic /* void */ wire_create_raw_external_message(NativePortType port_,String dst,String? state_init,String? body,int timeout);

external dynamic /* void */ wire_encode_internal_message(NativePortType port_,String? src,String dst,bool bounce,String? state_init,String? body,String amount,bool? bounced);

external dynamic /* void */ wire_make_full_account_boc(NativePortType port_,String? account_stuff_boc);

external dynamic /* void */ wire_parse_full_account_boc(NativePortType port_,String account);

external dynamic /* void */ wire_compute_storage_fee(NativePortType port_,String config,String account,int utime,bool is_masterchain);
...
external dynamic /* void */ wire_set_clock_offset(NativePortType port_,Object offset_ms);
...
external dynamic /* void */ wire_sign_fake__method__UnsignedMessageImpl(NativePortType port_,List<dynamic> that);
...
external dynamic /* void */ wire_get_transactions__method__GqlTransportImpl(NativePortType port_,List<dynamic> that,String address,String? from_lt,int count);

external dynamic /* void */ wire_get_transaction__method__GqlTransportImpl(NativePortType port_,List<dynamic> that,String hash);

external dynamic /* void */ wire_get_dst_transaction__method__GqlTransportImpl(NativePortType port_,List<dynamic> that,String message_hash);

external dynamic /* void */ wire_get_signature_id__method__GqlTransportImpl(NativePortType port_,List<dynamic> that);

external dynamic /* void */ wire_get_blockchain_config__method__GqlTransportImpl(NativePortType port_,List<dynamic> that,bool force);
...
external dynamic /* void */ wire_simulate_transaction_tree__method__GqlTransportImpl(NativePortType port_,List<dynamic> that,String signed_message,Int32List ignored_compute_phase_codes,Int32List ignored_action_phase_codes);

external dynamic /* void */ wire_new__static_method__ProtoTransportImpl(NativePortType port_,List<dynamic> proto_connection);

external dynamic /* void */ wire_get_contract_state__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,String address);

external dynamic /* void */ wire_get_full_contract_state__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,String address);

external dynamic /* void */ wire_get_accounts_by_code_hash__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,String code_hash,int limit,String? continuation);

external dynamic /* void */ wire_get_transactions__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,String address,String? from_lt,int count);

external dynamic /* void */ wire_get_transaction__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,String hash);

external dynamic /* void */ wire_get_dst_transaction__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,String message_hash);

external dynamic /* void */ wire_get_signature_id__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that);

external dynamic /* void */ wire_get_blockchain_config__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,bool force);

external dynamic /* void */ wire_get_network_id__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that);

external dynamic /* void */ wire_simulate_transaction_tree__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,String signed_message,Int32List ignored_compute_phase_codes,Int32List ignored_action_phase_codes);
...
external dynamic /* void */ wire_get_transactions__method__JrpcTransportImpl(NativePortType port_,List<dynamic> that,String address,String? from_lt,int count);

external dynamic /* void */ wire_get_transaction__method__JrpcTransportImpl(NativePortType port_,List<dynamic> that,String hash);

external dynamic /* void */ wire_get_dst_transaction__method__JrpcTransportImpl(NativePortType port_,List<dynamic> that,String message_hash);

external dynamic /* void */ wire_get_signature_id__method__JrpcTransportImpl(NativePortType port_,List<dynamic> that);

external dynamic /* void */ wire_get_blockchain_config__method__JrpcTransportImpl(NativePortType port_,List<dynamic> that,bool force);

external dynamic /* void */ wire_get_network_id__method__JrpcTransportImpl(NativePortType port_,List<dynamic> that);

external dynamic /* void */ wire_simulate_transaction_tree__method__JrpcTransportImpl(NativePortType port_,List<dynamic> that,String signed_message,Int32List ignored_compute_phase_codes,Int32List ignored_action_phase_codes);

external dynamic /* void */ wire_subscribe__static_method__TokenWalletDartWrapper(NativePortType port_,String instance_hash,String owner,String root_token_contract,Object transport,bool preload_transactions);
...
external dynamic /* void */ wire_estimate_min_attached_amount__method__TokenWalletDartWrapper(NativePortType port_,List<dynamic> that,String destination,String amount,bool notify_receiver,String? payload);
...
external dynamic /* void */ wire_get_token_root_details__static_method__TokenWalletDartWrapper(NativePortType port_,Object transport,String token_root_address);
...
external dynamic /* void */ wire_add_token_wallets__method__AccountsStorageImpl(NativePortType port_,List<dynamic> that,String account_address,String network_group,List<String> root_token_contracts);
...
external dynamic /* void */ wire_remove_token_wallets__method__AccountsStorageImpl(NativePortType port_,List<dynamic> that,String account_address,String network_group,List<String> root_token_contracts);
...
external dynamic /* void */ wire_subscribe__static_method__JettonWalletDartWrapper(NativePortType port_,String instance_hash,String owner,String root_token_contract,Object transport,bool preload_transactions);

external dynamic /* void */ wire_owner__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that);

external dynamic /* void */ wire_address__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that);

external dynamic /* void */ wire_balance__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that);

external dynamic /* void */ wire_contract_state__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that);

external dynamic /* void */ wire_estimate_min_attached_amount__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that,String destination);

external dynamic /* void */ wire_prepare_transfer__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that,String amount,String destination,String remaining_gas_to,String? custom_payload,String callback_value,String? callback_payload,String? attached_amount);

external dynamic /* void */ wire_refresh__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that);

external dynamic /* void */ wire_preload_transactions__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that,String from_lt);

external dynamic /* void */ wire_handle_block__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that,String block);

external dynamic /* void */ wire_get_jetton_wallet_details__static_method__JettonWalletDartWrapper(NativePortType port_,Object transport,String address);

external dynamic /* void */ wire_get_jetton_root_details_from_jetton_wallet__static_method__JettonWalletDartWrapper(NativePortType port_,Object transport,String token_wallet_address);

external dynamic /* void */ wire_get_jetton_root_details__static_method__JettonWalletDartWrapper(NativePortType port_,Object transport,String token_root_address);
...
external dynamic /* void */ wire_prepare_deploy_with_multiple_owners__method__TonWalletDartWrapper(NativePortType port_,List<dynamic> that,String expiration,List<String> custodians,int req_confirms,int? expiration_time);
...
external dynamic /* void */ wire_new__static_method__ProtoConnectionDartWrapper(NativePortType port_,String instance_hash);
...
class NekotonBridgeWire extends FlutterRustBridgeWasmWireBase<NekotonBridgeWasmModule> {
            ...
            void wire_verify_signature(NativePortType port_,String public_key,String data,String signature,int? signature_id) => wasmModule.wire_verify_signature(port_,public_key,data,signature,signature_id);
...
void wire_pack_into_cell(NativePortType port_,String params,String tokens,String? version) => wasmModule.wire_pack_into_cell(port_,params,tokens,version);

void wire_unpack_from_cell(NativePortType port_,String params,String boc,bool allow_partial,String? version) => wasmModule.wire_unpack_from_cell(port_,params,boc,allow_partial,version);
...
dynamic /* String */ wire_pack_address(String address,bool is_url_safe,bool bounceable) => wasmModule.wire_pack_address(address,is_url_safe,bounceable);
...
void wire_execute_local(NativePortType port_,String config,String account,String message,int utime,bool disable_signature_check,String? overwrite_balance,int? global_id) => wasmModule.wire_execute_local(port_,config,account,message,utime,disable_signature_check,overwrite_balance,global_id);

void wire_unpack_init_data(NativePortType port_,String contract_abi,String data) => wasmModule.wire_unpack_init_data(port_,contract_abi,data);

void wire_unpack_contract_fields(NativePortType port_,String contract_abi,String boc,bool allow_partial) => wasmModule.wire_unpack_contract_fields(port_,contract_abi,boc,allow_partial);

void wire_create_raw_external_message(NativePortType port_,String dst,String? state_init,String? body,int timeout) => wasmModule.wire_create_raw_external_message(port_,dst,state_init,body,timeout);

void wire_encode_internal_message(NativePortType port_,String? src,String dst,bool bounce,String? state_init,String? body,String amount,bool? bounced) => wasmModule.wire_encode_internal_message(port_,src,dst,bounce,state_init,body,amount,bounced);

void wire_make_full_account_boc(NativePortType port_,String? account_stuff_boc) => wasmModule.wire_make_full_account_boc(port_,account_stuff_boc);

void wire_parse_full_account_boc(NativePortType port_,String account) => wasmModule.wire_parse_full_account_boc(port_,account);

void wire_compute_storage_fee(NativePortType port_,String config,String account,int utime,bool is_masterchain) => wasmModule.wire_compute_storage_fee(port_,config,account,utime,is_masterchain);
...
void wire_init_runtime(NativePortType port_) => wasmModule.wire_init_runtime(port_);
...
void wire_set_clock_offset(NativePortType port_,Object offset_ms) => wasmModule.wire_set_clock_offset(port_,offset_ms);
...
void wire_sign_fake__method__UnsignedMessageImpl(NativePortType port_,List<dynamic> that) => wasmModule.wire_sign_fake__method__UnsignedMessageImpl(port_,that);
...
void wire_get_transactions__method__GqlTransportImpl(NativePortType port_,List<dynamic> that,String address,String? from_lt,int count) => wasmModule.wire_get_transactions__method__GqlTransportImpl(port_,that,address,from_lt,count);
...
void wire_get_dst_transaction__method__GqlTransportImpl(NativePortType port_,List<dynamic> that,String message_hash) => wasmModule.wire_get_dst_transaction__method__GqlTransportImpl(port_,that,message_hash);
...
void wire_get_blockchain_config__method__GqlTransportImpl(NativePortType port_,List<dynamic> that,bool force) => wasmModule.wire_get_blockchain_config__method__GqlTransportImpl(port_,that,force);
...
void wire_simulate_transaction_tree__method__GqlTransportImpl(NativePortType port_,List<dynamic> that,String signed_message,Int32List ignored_compute_phase_codes,Int32List ignored_action_phase_codes) => wasmModule.wire_simulate_transaction_tree__method__GqlTransportImpl(port_,that,signed_message,ignored_compute_phase_codes,ignored_action_phase_codes);

void wire_new__static_method__ProtoTransportImpl(NativePortType port_,List<dynamic> proto_connection) => wasmModule.wire_new__static_method__ProtoTransportImpl(port_,proto_connection);

void wire_get_contract_state__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,String address) => wasmModule.wire_get_contract_state__method__ProtoTransportImpl(port_,that,address);

void wire_get_full_contract_state__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,String address) => wasmModule.wire_get_full_contract_state__method__ProtoTransportImpl(port_,that,address);

void wire_get_accounts_by_code_hash__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,String code_hash,int limit,String? continuation) => wasmModule.wire_get_accounts_by_code_hash__method__ProtoTransportImpl(port_,that,code_hash,limit,continuation);

void wire_get_transactions__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,String address,String? from_lt,int count) => wasmModule.wire_get_transactions__method__ProtoTransportImpl(port_,that,address,from_lt,count);

void wire_get_transaction__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,String hash) => wasmModule.wire_get_transaction__method__ProtoTransportImpl(port_,that,hash);

void wire_get_dst_transaction__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,String message_hash) => wasmModule.wire_get_dst_transaction__method__ProtoTransportImpl(port_,that,message_hash);

void wire_get_signature_id__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that) => wasmModule.wire_get_signature_id__method__ProtoTransportImpl(port_,that);

void wire_get_blockchain_config__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,bool force) => wasmModule.wire_get_blockchain_config__method__ProtoTransportImpl(port_,that,force);

void wire_get_network_id__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that) => wasmModule.wire_get_network_id__method__ProtoTransportImpl(port_,that);

void wire_simulate_transaction_tree__method__ProtoTransportImpl(NativePortType port_,List<dynamic> that,String signed_message,Int32List ignored_compute_phase_codes,Int32List ignored_action_phase_codes) => wasmModule.wire_simulate_transaction_tree__method__ProtoTransportImpl(port_,that,signed_message,ignored_compute_phase_codes,ignored_action_phase_codes);
...
void wire_get_transactions__method__JrpcTransportImpl(NativePortType port_,List<dynamic> that,String address,String? from_lt,int count) => wasmModule.wire_get_transactions__method__JrpcTransportImpl(port_,that,address,from_lt,count);
...
void wire_get_dst_transaction__method__JrpcTransportImpl(NativePortType port_,List<dynamic> that,String message_hash) => wasmModule.wire_get_dst_transaction__method__JrpcTransportImpl(port_,that,message_hash);
...
void wire_get_blockchain_config__method__JrpcTransportImpl(NativePortType port_,List<dynamic> that,bool force) => wasmModule.wire_get_blockchain_config__method__JrpcTransportImpl(port_,that,force);
...
void wire_simulate_transaction_tree__method__JrpcTransportImpl(NativePortType port_,List<dynamic> that,String signed_message,Int32List ignored_compute_phase_codes,Int32List ignored_action_phase_codes) => wasmModule.wire_simulate_transaction_tree__method__JrpcTransportImpl(port_,that,signed_message,ignored_compute_phase_codes,ignored_action_phase_codes);

void wire_subscribe__static_method__TokenWalletDartWrapper(NativePortType port_,String instance_hash,String owner,String root_token_contract,Object transport,bool preload_transactions) => wasmModule.wire_subscribe__static_method__TokenWalletDartWrapper(port_,instance_hash,owner,root_token_contract,transport,preload_transactions);
...
void wire_estimate_min_attached_amount__method__TokenWalletDartWrapper(NativePortType port_,List<dynamic> that,String destination,String amount,bool notify_receiver,String? payload) => wasmModule.wire_estimate_min_attached_amount__method__TokenWalletDartWrapper(port_,that,destination,amount,notify_receiver,payload);
...
void wire_get_token_root_details__static_method__TokenWalletDartWrapper(NativePortType port_,Object transport,String token_root_address) => wasmModule.wire_get_token_root_details__static_method__TokenWalletDartWrapper(port_,transport,token_root_address);
...
void wire_add_token_wallets__method__AccountsStorageImpl(NativePortType port_,List<dynamic> that,String account_address,String network_group,List<String> root_token_contracts) => wasmModule.wire_add_token_wallets__method__AccountsStorageImpl(port_,that,account_address,network_group,root_token_contracts);
...
void wire_remove_token_wallets__method__AccountsStorageImpl(NativePortType port_,List<dynamic> that,String account_address,String network_group,List<String> root_token_contracts) => wasmModule.wire_remove_token_wallets__method__AccountsStorageImpl(port_,that,account_address,network_group,root_token_contracts);
...
void wire_owner__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that) => wasmModule.wire_owner__method__JettonWalletDartWrapper(port_,that);

void wire_address__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that) => wasmModule.wire_address__method__JettonWalletDartWrapper(port_,that);

void wire_balance__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that) => wasmModule.wire_balance__method__JettonWalletDartWrapper(port_,that);

void wire_contract_state__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that) => wasmModule.wire_contract_state__method__JettonWalletDartWrapper(port_,that);

void wire_estimate_min_attached_amount__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that,String destination) => wasmModule.wire_estimate_min_attached_amount__method__JettonWalletDartWrapper(port_,that,destination);

void wire_prepare_transfer__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that,String amount,String destination,String remaining_gas_to,String? custom_payload,String callback_value,String? callback_payload,String? attached_amount) => wasmModule.wire_prepare_transfer__method__JettonWalletDartWrapper(port_,that,amount,destination,remaining_gas_to,custom_payload,callback_value,callback_payload,attached_amount);

void wire_refresh__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that) => wasmModule.wire_refresh__method__JettonWalletDartWrapper(port_,that);

void wire_preload_transactions__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that,String from_lt) => wasmModule.wire_preload_transactions__method__JettonWalletDartWrapper(port_,that,from_lt);

void wire_handle_block__method__JettonWalletDartWrapper(NativePortType port_,List<dynamic> that,String block) => wasmModule.wire_handle_block__method__JettonWalletDartWrapper(port_,that,block);

void wire_get_jetton_wallet_details__static_method__JettonWalletDartWrapper(NativePortType port_,Object transport,String address) => wasmModule.wire_get_jetton_wallet_details__static_method__JettonWalletDartWrapper(port_,transport,address);

void wire_get_jetton_root_details_from_jetton_wallet__static_method__JettonWalletDartWrapper(NativePortType port_,Object transport,String token_wallet_address) => wasmModule.wire_get_jetton_root_details_from_jetton_wallet__static_method__JettonWalletDartWrapper(port_,transport,token_wallet_address);

void wire_get_jetton_root_details__static_method__JettonWalletDartWrapper(NativePortType port_,Object transport,String token_root_address) => wasmModule.wire_get_jetton_root_details__static_method__JettonWalletDartWrapper(port_,transport,token_root_address);
...
void wire_prepare_deploy_with_multiple_owners__method__TonWalletDartWrapper(NativePortType port_,List<dynamic> that,String expiration,List<String> custodians,int req_confirms,int? expiration_time) => wasmModule.wire_prepare_deploy_with_multiple_owners__method__TonWalletDartWrapper(port_,that,expiration,custodians,req_confirms,expiration_time);
...
void wire_new__static_method__ProtoConnectionDartWrapper(NativePortType port_,String instance_hash) => wasmModule.wire_new__static_method__ProtoConnectionDartWrapper(port_,instance_hash);
...
dynamic /*  */ drop_opaque_ArcJettonWalletBoxTrait( ptr) => wasmModule.drop_opaque_ArcJettonWalletBoxTrait(ptr);

int /* *const c_void */ share_opaque_ArcJettonWalletBoxTrait( ptr) => wasmModule.share_opaque_ArcJettonWalletBoxTrait(ptr);
...
dynamic /*  */ drop_opaque_ArcProtoConnectionBoxTrait( ptr) => wasmModule.drop_opaque_ArcProtoConnectionBoxTrait(ptr);

int /* *const c_void */ share_opaque_ArcProtoConnectionBoxTrait( ptr) => wasmModule.share_opaque_ArcProtoConnectionBoxTrait(ptr);
