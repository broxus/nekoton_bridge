...
Packages with other changes:
 ...
 - [`flutter_nekoton_bridge` - `v5.7.0-dev.2`](#flutter_nekoton_bridge---v570-dev2)
 - [`nekoton_bridge` - `v5.7.0-dev.2`](#nekoton_bridge---v570-dev2)
 - [`flutter_nekoton_bridge_example` - `v4.2.4-dev.4`](#flutter_nekoton_bridge_example---v424-dev4)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `flutter_nekoton_bridge_example` - `v4.2.4-dev.4`

---

#### `flutter_nekoton_bridge` - `v5.7.0-dev.2`

 - **FEAT**: remove temporary nt_tmp method and related references for package version bump.

#### `nekoton_bridge` - `v5.7.0-dev.2`
...
> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.
 ...
 - `flutter_nekoton_bridge_example` - `v4.2.4-dev.0`

---

#### `flutter_nekoton_bridge` - `v5.5.4-dev.0`
...
Packages with other changes:
 ...
 - [`nekoton_bridge` - `v5.5.0`](#nekoton_bridge---v550)
 - [`flutter_nekoton_bridge` - `v5.5.3`](#flutter_nekoton_bridge---v553)
 - [`flutter_nekoton_bridge_example` - `v4.2.3`](#flutter_nekoton_bridge_example---v423)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `flutter_nekoton_bridge` - `v5.5.3`
 - `flutter_nekoton_bridge_example` - `v4.2.3`

---

#### `nekoton_bridge` - `v5.5.0`
...
Packages graduated to a stable release (see pre-releases prior to the stable version for changelog entries):
 ...
 - `flutter_nekoton_bridge` - `v5.5.0`
 - `flutter_nekoton_bridge_example` - `v4.2.0`
 - `nekoton_bridge` - `v5.3.0`
...
Packages with other changes:
 ...
 - [`flutter_nekoton_bridge` - `v5.5.0-dev.0`](#flutter_nekoton_bridge---v550-dev0)
 - [`flutter_nekoton_bridge_example` - `v4.2.0-dev.0`](#flutter_nekoton_bridge_example---v420-dev0)
 - [`nekoton_bridge` - `v5.3.0-dev.0`](#nekoton_bridge---v530-dev0)

---

#### `flutter_nekoton_bridge` - `v5.5.0-dev.0`

 - **FEAT**(EWM-656): add signature domains support.

#### `flutter_nekoton_bridge_example` - `v4.2.0-dev.0`

 - **FEAT**(EWM-656): add signature domains support.

#### `nekoton_bridge` - `v5.3.0-dev.0`
...
Packages with other changes:
 ...
 - [`flutter_nekoton_bridge` - `v5.4.0`](#flutter_nekoton_bridge---v540)
 - [`flutter_nekoton_bridge_example` - `v4.1.3`](#flutter_nekoton_bridge_example---v413)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `flutter_nekoton_bridge_example` - `v4.1.3`

---

#### `flutter_nekoton_bridge` - `v5.4.0`
...
Packages with other changes:
 ...
 - [`flutter_nekoton_bridge` - `v5.1.0`](#flutter_nekoton_bridge---v510)
 - [`nekoton_bridge` - `v5.1.0`](#nekoton_bridge---v510)
 - [`flutter_nekoton_bridge_example` - `v4.0.1`](#flutter_nekoton_bridge_example---v401)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `flutter_nekoton_bridge_example` - `v4.0.1`

---

#### `flutter_nekoton_bridge` - `v5.1.0`

 - **FEAT**: update `nekoton`; add JettonBurnNotification model and integrate with TokenWalletTransaction.

#### `nekoton_bridge` - `v5.1.0`
...
Packages with other changes:
 ...
 - [`flutter_nekoton_bridge` - `v4.2.0`](#flutter_nekoton_bridge---v420)
 - [`flutter_nekoton_bridge_example` - `v3.1.0`](#flutter_nekoton_bridge_example---v310)
 - [`nekoton_bridge` - `v4.2.0`](#nekoton_bridge---v420)

---

#### `flutter_nekoton_bridge` - `v4.2.0`

 - **FEAT**(EWM-600): enhance public key validation and update API response handling.

#### `flutter_nekoton_bridge_example` - `v3.1.0`

 - **FEAT**(EWM-600): enhance public key validation and update API response handling.

#### `nekoton_bridge` - `v4.2.0`
...
Packages with other changes:
 ...
 - [`flutter_nekoton_bridge` - `v4.1.0`](#flutter_nekoton_bridge---v410)
 - [`flutter_nekoton_bridge_example` - `v3.0.2`](#flutter_nekoton_bridge_example---v302)
 - [`nekoton_bridge` - `v4.1.0`](#nekoton_bridge---v410)

Packages graduated to a stable release (see pre-releases prior to the stable version for changelog entries):

 - `flutter_nekoton_bridge` - `v4.1.0`
 - `flutter_nekoton_bridge_example` - `v3.0.2`
 - `nekoton_bridge` - `v4.1.0`
...
Packages with other changes:
 ...
 - [`flutter_nekoton_bridge` - `v4.1.0-dev.3`](#flutter_nekoton_bridge---v410-dev3)
 - [`flutter_nekoton_bridge_example` - `v3.0.2-dev.3`](#flutter_nekoton_bridge_example---v302-dev3)
 - [`nekoton_bridge` - `v4.1.0-dev.0`](#nekoton_bridge---v410-dev0)

---

#### `flutter_nekoton_bridge` - `v4.1.0-dev.3`

 - **FEAT**: add validateCell function and corresponding tests.

#### `flutter_nekoton_bridge_example` - `v3.0.2-dev.3`

 - **FEAT**: add validateCell function and corresponding tests.

#### `nekoton_bridge` - `v4.1.0-dev.0`
...
> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.
 ...
 - `flutter_nekoton_bridge_example` - `v3.0.2-dev.1`

---

#### `flutter_nekoton_bridge` - `v4.1.0-dev.1`
...
Packages with other changes:
 ...
 - [`flutter_nekoton_bridge` - `v4.1.0-dev.0`](#flutter_nekoton_bridge---v410-dev0)
 - [`flutter_nekoton_bridge_example` - `v3.0.2-dev.0`](#flutter_nekoton_bridge_example---v302-dev0)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `flutter_nekoton_bridge_example` - `v3.0.2-dev.0`

---

#### `flutter_nekoton_bridge` - `v4.1.0-dev.0`
...
Packages with other changes:
 ...
 - [`nekoton_bridge` - `v4.0.1`](#nekoton_bridge---v401)
 - [`flutter_nekoton_bridge` - `v4.0.1`](#flutter_nekoton_bridge---v401)
 - [`flutter_nekoton_bridge_example` - `v3.0.1`](#flutter_nekoton_bridge_example---v301)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `flutter_nekoton_bridge` - `v4.0.1`
 - `flutter_nekoton_bridge_example` - `v3.0.1`

---

#### `nekoton_bridge` - `v4.0.1`
...
Packages with breaking changes:
 ...
 - [`flutter_nekoton_bridge` - `v4.0.0`](#flutter_nekoton_bridge---v400)
 - [`flutter_nekoton_bridge_example` - `v3.0.0`](#flutter_nekoton_bridge_example---v300)
 - [`nekoton_bridge` - `v4.0.0`](#nekoton_bridge---v400)
...
Packages graduated to a stable release (see pre-releases prior to the stable version for changelog entries):
 ...
 - `flutter_nekoton_bridge` - `v4.0.0`
 - `flutter_nekoton_bridge_example` - `v3.0.0`
 - `nekoton_bridge` - `v4.0.0`
...
Packages with other changes:
 ...
 - [`flutter_nekoton_bridge` - `v1.25.1`](#flutter_nekoton_bridge---v1251)
 - [`flutter_nekoton_bridge_example` - `v1.16.3`](#flutter_nekoton_bridge_example---v1163)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `flutter_nekoton_bridge_example` - `v1.16.3`

---

#### `flutter_nekoton_bridge` - `v1.25.1`
...
Packages with other changes:
 ...
 - [`nekoton_bridge` - `v1.11.1`](#nekoton_bridge---v1111)
 - [`flutter_nekoton_bridge` - `v1.18.1`](#flutter_nekoton_bridge---v1181)
 - [`flutter_nekoton_bridge_example` - `v1.11.5`](#flutter_nekoton_bridge_example---v1115)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `flutter_nekoton_bridge` - `v1.18.1`
 - `flutter_nekoton_bridge_example` - `v1.11.5`

---

#### `nekoton_bridge` - `v1.11.1`
...
Packages with other changes:
 ...
 - [`flutter_nekoton_bridge` - `v1.18.0`](#flutter_nekoton_bridge---v1180)
 - [`flutter_nekoton_bridge_example` - `v1.11.4`](#flutter_nekoton_bridge_example---v1114)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `flutter_nekoton_bridge_example` - `v1.11.4`

---

#### `flutter_nekoton_bridge` - `v1.18.0`
...
Packages with other changes:
 ...
 - [`flutter_nekoton_bridge` - `v1.13.0`](#flutter_nekoton_bridge---v1130)
 - [`flutter_nekoton_bridge_example` - `v1.10.0`](#flutter_nekoton_bridge_example---v1100)

---

#### `flutter_nekoton_bridge` - `v1.13.0`
...
#### `flutter_nekoton_bridge_example` - `v1.10.0`
